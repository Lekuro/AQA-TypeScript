...
test.describe('Main page:', () => {
    ...
    test('header switch btn should change theme color', async () => {
    ...
    test('modal search should be opened', async () => {
    ...
    test('Algolia btn in modal-search should redirect to Algolia page', async ({ context }) => {
        // Set up a promise to wait for the new page
        const newPagePromise = context.waitForEvent('page');
        await test.step('click search button', async () => {
            await mainPage.headerComponent.clickSearchButton();
